...
def recursive_generator(input_image, width):
    ar = config.TRAIN.aspect_ratio # default: 1 (长宽比)
    ...
    if width == config.TRAIN.sp*config.TRAIN.aspect_ratio:  # TRAIN.sp (default: 256) (输出图片的尺寸，做个最后的处理)
